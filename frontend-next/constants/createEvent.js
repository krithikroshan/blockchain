export const types = [
    {key: 'AS', value: 'Appearance or Signing'},
    {key: 'AT', value: 'Attraction'},
    {key: 'CT', value: 'Camp, Trip or Retreat'},
    {key: 'CP', value: 'Concert or Performance'},
    {key: 'CF', value: 'Conference'},
    {key: 'CV', value: 'Convention'},
    {key: 'CW', value: 'Course, Training or Workshop'},
    {key: 'FF', value: 'Festival or Fair'},
    {key: 'GC', value: 'Game or Competition'},
    {key: 'MN', value: 'Meeting or Networking'},
    {key: 'OT', value: 'Other'},
    {key: 'PS', value: 'Party or Social Gathering'},
    {key: 'RE', value: 'Race or Endurance Event'},
    {key: 'RL', value: 'Rally'},
    {key: 'SC', value: 'Screening'},
    {key: 'ST', value: 'Seminar or Talk'},
    {key: 'TR', value: 'Tour'},
    {key: 'TT', value: 'Tournament'},
    {key: 'TE', value: 'Tradeshow or Expo'},
]

export const categories = [
    {key:'AB', value:'Auto, Boat & Air'},
    {key:'BP', value:'Business & Professional'},
    {key:'CC', value:'Charities & Causes'},
    {key:'CO', value:'Communities & Culture'},
    {key:'FE', value:'Family & Education'},
    {key:'FB', value:'Fashion & Beauty'},
    {key:'FM', value:'Fild, Media & Entertainment'},
    {key:'FD', value:'Food & Drink'},
    {key:'GP', value:'Government & Politics'},
    {key:'HW', value:'Health & Wellness'},
    {key:'HS', value:'Hobbies & Special Interests'},
    {key:'HL', value:'Home & Lifestyle'},
    {key:'MU', value:'Music'},
    {key:'OT', value:'Other'},
    {key:'PA', value:'Performing & Visual Arts'},
    {key:'RS', value:'Religion & Spirituality'},
    {key:'SA', value:'School Activities'},
    {key:'ST', value:'Science & Technology'},
    {key:'SE', value:'Seasonal'},
    {key:'SF', value:'Sports & Fitness'},
    {key:'TO', value:'Travel & Outdoor'}
]
